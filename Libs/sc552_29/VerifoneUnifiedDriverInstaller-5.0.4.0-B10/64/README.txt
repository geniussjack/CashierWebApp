VeriFone Unified USB Driver Installer (64-bit): VerifoneUnifiedDriverInstaller64.msi version 5.0.4.0
Build 10
...
*** This release supports :*** 
    ...
    Windows platforms : 
        ...
        Win 10                64 bit    Microsoft Signed
        Win 8.1               64 bit    Microsoft Signed
        Win 8                 64 bit    Microsoft Signed
        Win 7                 64 bit    Microsoft Signed
        Win Vista             64 bit    Microsoft Signed
        Win XP                64 bit    Microsoft Signed
					
	Terminal Series	:
       
        Vx (both Verix Vand eVo ).
...
NOTE: If VerifoneUnifiedDriverInstaller64.msi is ran without any parameters, the install will
...
msiexec /qn /i VerifoneUnifiedDriverInstaller64.msi PORT_RETAIN=1 PORT_VX=6 PORT_MX=7 PORT_ROOT_LINK_NAME=COM
...
The VeriFone USB Driver Installer and installed drivers can be uninstalled from:
  ...
  - Silent uninstall: run "msiexec /qn /x VerifoneUnifiedDriverInstaller64.msi" 
    with administrative privileges


To change COM port AFTER device is installed and connected:
  - Regular: Run VerifoneUnifiedDriverInstaller64.msi and follow the instructions to "Modify" 
             the install.
  - Silent: Re-run "VerifoneUnifiedDriverInstaller64.msi  PORT=#" and pass in 
